  ...
  <div class="resource-details-container">
        ...
        <template #header>
          <div class="card-header">
            ...
            <div class="card-header-right">
              <el-button v-if="resource.url" tag="a" :href="resource.url" target="_blank" type="primary" round>
                <el-icon>
                  <Position />
                </el-icon>
                <span>访问资源</span>
    ...
    <div class="sidebar">
      ...
      <el-card shadow="never" class="card"
        v-if="resource.tab === '文件' && resource.fileData && resource.fileData.length > 0">
        <template #header>
        ...
        <div class="file-list">
          <a v-for="file in resource.fileData" :key="file.id" :href="file.fileUrl" target="_blank"
